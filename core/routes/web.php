...
*/
	...
	Route::get('/emails', 'MailController@showAllMails')->name('admin.mails.show');
...
Route::prefix('')->group(function () {
	...
	Route::get('/', 'UserController@showUserIndexPage')->name('user.index');

	Route::get('/apply', 'UserController@showApplyForm')->name('user.apply.show');
	Route::post('/apply', 'UserController@submitApplyForm')->name('user.apply.submit');

	Route::post('/send-message', 'UserController@submitMailMethod')->name('user.message.submit');
});
